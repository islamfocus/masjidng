...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 6.5244;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3.3792;
...
function searchResultsHTML(masajid) {
  return masajid.map(function (masjid) {
    return '\n      <a href="/masjid/' + masjid.slug + '" class="search__result">\n        <strong>' + masjid.name + '</strong>\n      </a>\n    ';
  }).join('');
}
...
(0, _autocomplete2.default)((0, _bling.$)('#state'));
